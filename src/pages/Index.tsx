        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
             <span className=' text-slate-800'>Notre </span> <span className="bg-gradient-to-r from-green-700 via-green-600 to-green-800 bg-clip-text text-transparent  ">Mission</span>
            </h2>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 ">
          <div className="flex items-center justify-between mb-6 gap-4">
            <h2 className="text-3xl md:text-4xl font-bold">
             <span className=' text-slate-700'> Dernières </span><span className="bg-gradient-to-r from-green-500 via-green-600 to-green-700 bg-clip-text text-transparent">Actualités</span>
            </h2>
            <Link
              to="/actualites"
              className="flex items-center gap-2 hover:text-green-600 transition-colors text-sm font-semibold"
            >
              <span  className=" text-slate-800" >Tous</span>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/nous-soutenir">
              <Button size="lg" className="bg-white  text-slate-800 hover:bg-white/90 font-semibold px-8 py-4">
                Nous soutenir
              </Button>
            </Link>
            <Link to="/evenement">
              <Button 
                size="lg" 
                className="btn-transparent bg-gradient-to-r from-green-500 via-green-400 to-green-500 font-semibold px-8 py-4"
              >
                Nos événements
              </Button>
            </Link>
