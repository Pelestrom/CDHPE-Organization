            ...
            <div className="space-y-8 animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/nous-soutenir">
                  <Button size="lg" className="bg-white  text-slate-800 hover:bg-white/90 font-semibold px-8 py-4   button-3d">
                ...
                <Link to="/actualites">
                  <Button 
                    size="lg" 
                    className="btn-transparent bg-gradient-to-r from-green-500 via-green-400 to-green-500 font-semibold px-8 py-4 text-lg"
                  >
